...
# plot log2-normalised REC8 and other coverage profiles (genome-scale), adjusted so that the genome-wide average and SD of log2 ratio scores are 0 and 1, respectively (standard score)
...
pdf(file = paste0(outDir, "REC8_vs_Others_log2norm_standardscore_genomeplot_", winNames[1], "_h10w15.pdf"), height = 10, width = 15)
par(mfcol = c(4, 2))
...
pdf(file = paste0(outDir, "REC8_vs_SPO11-1_COs_MSH4_log2_standardscore_genomeplot_", winNames[1], "_h10w15.pdf"), height = 10, width = 15)
par(mfcol = c(4, 2))
par(mar = c(2.1, 4.1, 2.1, 4.1))
par(mgp = c(3, 1, 0))
...
pdf(file = paste0(outDir, "genome-wide_correlation_matrix_", winNames[1], "_circle.pdf"))
...
pdf(file = paste0(outDir, "genome-wide_correlation_matrix_", winNames[1], "_square.pdf"))
corrplot(allDF_corMat, method = "square", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", addCoef.col = "white", mar = c(0,0,1,0),
         title = paste0("Genome-wide Spearman correlation matrix (10-kb windows)"))
dev.off()

pdf(file = paste0(outDir, "genome-wide_correlation_matrix_", winNames[1], "_colouronly.pdf"))
...
pdf(file = paste0(outDir, "genome-wide_correlation_matrix_", winNames[1], "_number.pdf"))
corrplot(allDF_corMat, method = "number", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", mar = c(0,0,1,0),
         title = paste0("Genome-wide Spearman correlation matrix (10-kb windows)"))
dev.off()

pdf(file = paste0(outDir, "genome-wide_correlation_matrix_", winNames[1], "_pie.pdf"))
...
allDF_corMat <- cor(allDF, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "genome-wide_correlation_matrix_", winNames[1], "_colouronly_v02.pdf"))
corrplot(allDF_corMat, method = "color", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", addCoef.col = "white", mar = c(0,0,1,0), tl.cex = 0.8, cl.cex = 0.8, number.cex = 0.8,
         title = paste0("Genome-wide Spearman correlation matrix (10-kb windows)"))
dev.off()
...
# log2-normalised REC8 and other coverage profiles (genome-scale), adjusted so that the genome-wide average and SD of log2 ratio scores are 0 and 1, respectively (standard score)
...
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "arm_correlation_matrix_", winNames[1], "_colouronly_unsmoothed.pdf"))
...
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "peri_correlation_matrix_", winNames[1], "_colouronly_unsmoothed.pdf"))
...
allDF_arm_corMat <- cor(allDF_arm, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "arm_correlation_matrix_", winNames[1], "_colouronly.pdf"))
corrplot(allDF_arm_corMat, method = "color", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", addCoef.col = "white", mar = c(0,0,1,0), tl.cex = 0.8, cl.cex = 0.8, number.cex = 0.8,
         title = paste0("Arms Spearman correlation matrix (10-kb windows)"))
dev.off()
...
allDF_peri_corMat <- cor(allDF_peri, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "peri_correlation_matrix_", winNames[1], "_colouronly.pdf"))
corrplot(allDF_peri_corMat, method = "color", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", addCoef.col = "white", mar = c(0,0,1,0), tl.cex = 0.8, cl.cex = 0.8, number.cex = 0.8,
         title = paste0("Pericentromeres Spearman correlation matrix (10-kb windows)"))
dev.off()
...
allDF_arm_corMat <- cor(allDF_arm, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "arm_correlation_matrix_", winNames[1], "_colouronly_v02.pdf"))
corrplot(allDF_arm_corMat, method = "color", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", addCoef.col = "white", mar = c(0,0,1,0), tl.cex = 0.8, cl.cex = 0.8, number.cex = 0.8,
         title = paste0("Arms Spearman correlation matrix (10-kb windows)"))
dev.off()
...
allDF_peri_corMat <- cor(allDF_peri, method = "spearman", use = "pairwise.complete.obs")
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "peri_correlation_matrix_", winNames[1], "_colouronly_v02.pdf"))
corrplot(allDF_peri_corMat, method = "color", type = "upper", col = col1(20), tl.col = "black",
         addgrid.col = "white", addCoef.col = "white", mar = c(0,0,1,0), tl.cex = 0.8, cl.cex = 0.8, number.cex = 0.8,
         title = paste0("Pericentromeres Spearman correlation matrix (10-kb windows)"))
dev.off()
...
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "genome-wide_correlation_matrix_REC8_SPO11_crossovers_", winNames[1], "_colouronly.pdf"))
...
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "arm_correlation_matrix_REC8_SPO11_crossovers_", winNames[1], "_colouronly.pdf"))
...
col1 <- colorRampPalette(c("red", "white", "blue"))
pdf(file = paste0(outDir, "peri_correlation_matrix_REC8_SPO11_crossovers_", winNames[1], "_colouronly.pdf"))
